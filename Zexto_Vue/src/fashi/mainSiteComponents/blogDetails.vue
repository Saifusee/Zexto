                ...
                <div class="col-lg-12">
                    <div class="blog-details-inner">
                        ...
                        <div class="blog-large-pic">
                            <img :src="this.ROOT_URL + 'img/blog/blog-detail.jpg'" alt="">
                        </div>
                        ...
                        <div class="blog-more">
                            <div class="row">
                                <div class="col-sm-4">
                                    <img :src="this.ROOT_URL + 'img/blog/blog-detail-1.jpg'" alt="">
                                </div>
                                <div class="col-sm-4">
                                    <img :src="this.ROOT_URL + 'img/blog/blog-detail-2.jpg'" alt="">
                                </div>
                                <div class="col-sm-4">
                                    <img :src="this.ROOT_URL + 'img/blog/blog-detail-3.jpg'" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="posted-by">
                            <div class="pb-pic">
                                <img :src="this.ROOT_URL + 'img/blog/post-by.png'" alt="">
                            </div>
                            <div class="pb-text">
                                <a href="#">
                                    <h5>Shane Lynch</h5>
