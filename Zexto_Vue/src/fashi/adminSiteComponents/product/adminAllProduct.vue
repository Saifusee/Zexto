...
export default {
  data()
  {
    return{
      ...
      columns: ['product_main_image', 'id', 'product_name', 'product_amount', 'product_previous_amount', 'product_stock', 'vendor', 'product_tags', 'product_status', 'product_category', 'created_at', 'updated_at', 'change_status', 'edit', 'delete'],
      ...
      options: {
        ...
        filterable: ['product_main_image', 'id', 'product_name', 'product_amount', 'product_previous_amount', 'product_stock', 'vendor', 'product_tags', 'product_status', 'product_category', 'created_at', 'updated_at'],
