        ...
        <div class="container-fluid">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">Add Blog</h3>
              <small>Add a new blog to Zexto</small>
            </div>
            <div class="card-body">
                <form enctype="multipart/form-data" @submit.prevent>
                    ...
                    <hr>
                    <button type="submit" class="form-control btn btn-secondary" @click.keyup.enter="submitBlog">Create Blog</button>
                </form>
            </div>
          </div>
...
export default {
    ...
    created()
    {
        //JUst clearing all previous data regarding blog in vuex
        ...
        this.methodBlogMainImage("");
        this.methodBlogSubImage1("");
        this.methodBlogSubImage2("");
        this.methodBlogSubImage3("");
    },
