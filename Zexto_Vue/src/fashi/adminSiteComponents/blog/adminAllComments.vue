        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">All Comments</h3>
              <small>Details of all the comments on Zexto Blogs.</small>
            </div>
            <div class="card-body">
...
export default {
  ...
  methods:
  {
    ...
    //Calling Modal for changing user's vendor approval status
    commentStatus(id, commentUser)
    {
      let title, body, button, source;
      title = `Change Comment Approval Status`;
